...
Below are some notes on how to build Sexcoin Core for Windows.
...
way. This will install to `c:\workspace\sexcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/sexcoin
