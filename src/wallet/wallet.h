...
public:
    ...
    // Sexcoin: SegWit removed the coinbase merkle tree and only included it for
    // Sexcoin: backwards compatibility with older bitcoin clients.
    // Sexcoin: Sexcoin still needs it here
